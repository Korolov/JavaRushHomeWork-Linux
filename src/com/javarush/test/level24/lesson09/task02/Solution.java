    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int r1= ((String)(stock1.get("name"))).compareTo((String)stock2.get("name"));
                if (r1!=0){
                    return r1;

                }
                else{
                    int r2=((Date)(stock1.get("date"))).compareTo((Date)stock2.get("date"));
                    if(r2!=0){
                        return r2;
                    }
                    else{
                         ...
                         if(stock1.containsKey("change"))
                             return Double.compare((Double)stock1.get("change"),(Double)stock2.get("change"));
                        else
                        return -Double.compare((((Double)stock1.get("last"))-((Double)stock1.get("open"))),(((Double)stock2.get("last"))-((Double)stock2.get("open"))));
