...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String oneName="className:"+one.getClass().getSimpleName().toLowerCase();
        String twoName="className:"+resultClassObject.getClass().getSimpleName().toLowerCase();
        o=o.replaceFirst(oneName,twoName);
        StringReader reader=new StringReader(o);



        return resultClassObject=mapper.readValue(o,resultClassObject.getClass());
    }
