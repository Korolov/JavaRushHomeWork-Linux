...
public class Solution {
    ...
    public Solution(String pathToFile) {
        try{fileData=new ConcreteFileData(Paths.get(pathToFile).toFile().isHidden(), Files.isExecutable(Paths.get(pathToFile)),Files.isDirectory(Paths.get(pathToFile)),Files.isWritable(Paths.get(pathToFile)));}
        catch (Exception e){
